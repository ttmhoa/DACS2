...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Shopee Rating">
    <meta name="keywords" content="Shopee, Rating, HTML, CSS">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Shopee Style Rating</title>
    <!-- Google Font -->
...
<div class="upload-section">
    <div class="upload-box">
        ...
        <div class="preview-box" id="image-preview"></div>
    </div>
    <div class="upload-box">
        <!-- <span>video</span> -->
        <input type="file" accept="video/*" id="video"/>
        <div class="preview-box" id="video-preview"></div>
    </div>
</div>
<textarea id="review-text" rows="4" placeholder="Viết đánh giá của bạn..."></textarea>
<button id="submit-btn">Gửi đánh giá</button>
<script src="/ogani-master/public/js/scriptpreview.js"></script>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById("submit-btn").addEventListener('click', async function() {
        ...
        if (!selectedProductId) {
            alert("Vui lòng chọn sản phẩm trước khi gửi đánh giá!");
            return; 
        }

        formData.append('rating', ratingValue);
        formData.append('review', reviewText);
        formData.append('product_ids', JSON.stringify([selectedProductId]));
        if (imageFile ) {
        ...
        try {
            const response = await fetch('/ratingController/rating', {
                method: 'POST',
                body: formData
            });
