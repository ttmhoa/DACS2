             ...
             <div class="col-lg-9">
                 ...
                 <div class="hero__item set-bg" data-setbg="/ogani-master/img/hero/banner.jpg">
                     <div class="hero__text">
                         ...
                         <a href="/shopcontroller" class="primary-btn">SHOP NOW</a>
                     </div>
                 </div>
             </div>
         </div>
         ...
         <div class="row">
             <div class="categories__slider owl-carousel">
                 <?php while ($row = mysqli_fetch_array($data["categories"])) { ?>
                     <div class="col-lg-3">
                         <div class="categories__item set-bg" data-setbg="<?php echo $row['image']; ?>">
 ...
 <section class="featured spad">
     <div class="container">
         ...
         <div class="row featured__filter">
             <?php
                while ($row3 = mysqli_fetch_array($data["detail"])) { ?>

                 <div class="col-lg-3 col-md-4 col-sm-6 <?php ?>">
                     <div class="featured__item">

                         <div class="featured__item__pic set-bg" data-setbg="<?php echo $row3['image']; ?>">

                             <ul class="featured__item__pic__hover">

                                 <li><a href="/shopdetailcontroller/Viewnews/shopdetail/<?php echo $row3['id']; ?>">
                         ...
                         <div class="featured__item__text">
                             <h6><a href="#"><?php echo $row3['title']; ?></a></h6>
                             <h5><?php echo $row3['price']; ?></h5>
                         </div>
                     </div>
                 </div>
             <?php } ?>
                 ...
                 <div class="latest-product__text">
                     ...
                     <div class="latest-product__slider owl-carousel">
                         ...
                         <div class="latest-prdouct__slider__item">
                             <?php while ($row4 = mysqli_fetch_array($data["get3latest"])) { ?>
                         ...
                         <div class="latest-prdouct__slider__item">
                             <?php while ($row5 = mysqli_fetch_array($data["get3related"])) { ?>
                                 <a href="#" class="latest-product__item">
                                     <div class="latest-product__item__pic">
